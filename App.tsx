      ...
      <section id="portfolio" className="py-24 bg-sans-bg">
        <div className="container mx-auto px-6 text-center">
           ...
           <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
              <div className="rounded-2xl overflow-hidden h-64 group relative cursor-scale">
              ...
              <div className="rounded-2xl overflow-hidden h-64 group relative md:col-span-2 cursor-scale">
